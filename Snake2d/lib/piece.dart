...
class _PieceState extends State<Piece> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    super.initState();
    _animationController = AnimationController(vsync: this,lowerBound: 0.25,upperBound: 1.0,duration: const Duration(milliseconds: 1000));
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
        ...
        child: Opacity(opacity: widget.isAnimated ? _animationController.value : 1.0,
    child: Container(
